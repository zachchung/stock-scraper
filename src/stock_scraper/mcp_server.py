...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "- income_statements: symbol, fiscal_date, frequency (annual|quarterly), total_revenue, gross_profit, operating_income, net_income, diluted_eps, net_profit_margin (derived: net_income/total_revenue)\n"
        "- cashflow_statements: symbol, fiscal_date, frequency (annual|quarterly), operating_cash_flow, capital_expenditure, free_cash_flow, financing_cash_flow, investing_cash_flow\n"
        "- balance_sheets: symbol, fiscal_date, frequency (annual|quarterly), total_assets, total_liabilities, total_equity, total_debt, cash_and_equivalents, etc.\n"
